...
namespace TP1_PROGRAMACIONII
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            FCA fca1 = new FCA();
            consecionaria1.AsignarFCA("FinanciacionYA");
            consecionaria1.AgregarCliente(cliente1);
            consecionaria1.AgregarVehiculo(vehiculo1);
            cliente1.AveriguarFinanciacion(vehiculo1);
            fca1.FinanciarVehiculo(vehiculo1);
            consecionaria1.InformarFinanciacion(vehiculo1);

            Console.WriteLine("MARCA:" + vehiculo1.Marca +  "   " + "PATENTE:" + vehiculo1.Patente +  "   " + "PRECIO FINANCIADO:$" +  consecionaria1.InformarFinanciacion(vehiculo1));
            Console.ReadLine();
